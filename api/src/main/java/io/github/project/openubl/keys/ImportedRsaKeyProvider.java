...
public class ImportedRsaKeyProvider extends AbstractRsaKeyProvider {
    ...
    public ImportedRsaKeyProvider(OrganizationModel organizaton, ComponentModel model) {
        super(organizaton, model);
    }

    @Override
    public KeyWrapper loadKey(OrganizationModel organization, ComponentModel model) {
