...
import org.openublpe.xmlbuilder.apisigner.keys.component.utils.ComponentProviderLiteral;
import org.openublpe.xmlbuilder.apisigner.keys.component.utils.RsaKeyProviderLiteral;
...
public class DefaultKeyManager implements KeyManager {
    ...
    private List<KeyProvider> getProviders(OrganizationModel organization) {
        ...
        if (providers == null) {
            ...
            List<ComponentModel> components = new LinkedList<>(componentProvider.getComponents(organization, KeyProvider.class.getName()));
