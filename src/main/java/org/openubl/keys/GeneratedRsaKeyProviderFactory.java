...
import org.openubl.keys.provider.ConfigurationValidationHelper;
import org.openubl.keys.provider.ProviderConfigProperty;
import org.openubl.keys.qualifiers.ComponentProviderType;
import org.openubl.keys.qualifiers.RsaKeyProviderType;
...
public class GeneratedRsaKeyProviderFactory extends AbstractRsaKeyProviderFactory {
    ...
    @Override
    public boolean createFallbackKeys(OrganizationModel organization, KeyUse keyUse, String algorithm) {
