 ...
 */
package org.openubl.keys.component;

import org.openubl.keys.provider.ConfiguredProvider;
import org.openubl.keys.provider.ProviderConfigProperty;
import org.openubl.keys.provider.ProviderFactory;
...
public interface ComponentFactory<CreatedType, ProviderType> extends ProviderFactory<ProviderType>, ConfiguredProvider {
    ...
    default void preRemove(OrganizationModel organization, ComponentModel model) {
    }
